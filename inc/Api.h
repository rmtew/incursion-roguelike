...
system uint16 T_CREATURE::Percieves(hObj:T_THING);
...
system int16  T_CREATURE::SpellRating(rID eID,int32 mm=0,bool percieved=false);
...
system void   T_CREATURE::GainInherantBonus(int16 attr, int16 mag, bool msg=true);
